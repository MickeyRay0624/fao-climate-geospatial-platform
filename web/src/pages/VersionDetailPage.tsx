...
import type { DataHubVersion } from "../platform/types";
...
export default function VersionDetailPage() {
  ...
  return (
    <div className="platform-page detail-page version-page">
      ...
      {activeTab === "Preview" && <section className="detail-panel"><p className="platform-kicker">Authorised preview</p><h2>Sample representation</h2><p className="panel-note">Preview access is re-authorised and audited. Only the first sample records are exposed.</p>{preview ? <pre className="json-preview">{JSON.stringify(preview, null, 2)}</pre> : <div className="platform-loading">Loading preview…</div>}</section>}
